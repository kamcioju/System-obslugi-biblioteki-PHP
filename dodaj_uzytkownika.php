...
$_POST['email'] = mysqli_real_escape_string($link , $_POST['email']);
	...
	{
		echo '<center><br><br><h3>Uzytkownik dodany, kliknij w link potwierdzajacy otrzymany w mailu</h3><br><br></center><meta http-equiv="refresh" content="3;url=zaloguj.php">';
	}
